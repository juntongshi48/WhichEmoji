...
class preprocessing:
    def __init__(self, raw_paths, test_size: int=0.2) -> None:
    ...
    def process_and_save_to_csv(self, raw_path, output_dir, label):
        ...
        # Process tweets: list of long string separated by "\t"
        processed_tweets = ["\t".join(self.extract_words(tweet)) for tweet in tweets]
